...
(function(global) {
        ...
        return {
            agents: [
                { 
                    ...
                    role: 'CEO', 
                    status: 'active', 
                    currentTask: 'Strategic product roadmap review', 
                    emoji: '👑', 
                    lastSeen: new Date(now - 45000).toISOString(), 
                    lastSeenRelative: '45s ago', 
                    tokensUsed: 24800, 
                    apiCalls: 127, 
                    model: 'claude-opus-4-6',
                    lastSeenMs: now - 45000
                },
                { 
                    id: 'forge', 
                    name: 'Forge', 
                    role: 'CTO', 
                    status: 'building', 
                    currentTask: 'SpawnKit v2 architecture implementation', 
                    emoji: '🔨', 
                    lastSeen: new Date(now - 180000).toISOString(), 
                    lastSeenRelative: '3m ago', 
                    tokensUsed: 31200, 
                    apiCalls: 89, 
                    model: 'claude-opus-4-6',
                    lastSeenMs: now - 180000
                },
                { 
                    id: 'atlas', 
                    name: 'Atlas', 
                    role: 'COO', 
                    status: 'organizing', 
                    currentTask: 'Fleet operations optimization', 
                    emoji: '📊', 
                    lastSeen: new Date(now - 420000).toISOString(), 
                    lastSeenRelative: '7m ago', 
                    tokensUsed: 18600, 
                    apiCalls: 64, 
                    model: 'claude-sonnet-4',
                    lastSeenMs: now - 420000
                },
                { 
                    id: 'hunter', 
                    name: 'Hunter', 
                    role: 'CRO', 
                    status: 'researching', 
                    currentTask: 'Q1 2026 market expansion analysis', 
                    emoji: '🎯', 
                    lastSeen: new Date(now - 600000).toISOString(), 
                    lastSeenRelative: '10m ago', 
                    tokensUsed: 15400, 
                    apiCalls: 43, 
                    model: 'claude-sonnet-4',
                    lastSeenMs: now - 600000
                },
                { 
                    id: 'echo', 
                    name: 'Echo', 
                    role: 'CMO', 
                    status: 'creating', 
                    currentTask: 'Product launch content strategy', 
                    emoji: '📢', 
                    lastSeen: new Date(now - 840000).toISOString(), 
                    lastSeenRelative: '14m ago', 
                    tokensUsed: 12900, 
                    apiCalls: 56, 
                    model: 'claude-haiku-4-5',
                    lastSeenMs: now - 840000
                },
                { 
                    id: 'sentinel', 
                    name: 'Sentinel', 
                    ...
                    status: 'monitoring', 
                    currentTask: 'System security audit & compliance', 
                    emoji: '🛡️', 
                    lastSeen: new Date(now - 1200000).toISOString(), 
                    lastSeenRelative: '20m ago', 
                    tokensUsed: 8200, 
                    apiCalls: 29, 
                    model: 'claude-haiku-4-5',
                    lastSeenMs: now - 1200000
                },
                { 
                    id: 'nova', 
                    name: 'Nova', 
                    role: 'Lead Designer', 
                    status: 'active', 
                    currentTask: 'UI/UX design system refinement', 
                    emoji: '🎨', 
                ...
                { 
                    ...
                    role: 'Data Scientist', 
                    status: 'analyzing', 
                    currentTask: 'User engagement pattern analysis', 
                    emoji: '📈', 
                    lastSeen: new Date(now - 480000).toISOString(), 
                    lastSeenRelative: '8m ago', 
                    tokensUsed: 14300, 
                    apiCalls: 52, 
                    model: 'claude-sonnet-4',
                    lastSeenMs: now - 480000
                },
                { 
                    id: 'cipher', 
                    name: 'Cipher', 
                    ...
                    status: 'idle', 
                    currentTask: 'Infrastructure monitoring (standby)', 
                    emoji: '⚙️', 
                    lastSeen: new Date(now - 1800000).toISOString(), 
                    lastSeenRelative: '30m ago', 
                    tokensUsed: 5600, 
                    apiCalls: 18, 
                    model: 'claude-haiku-4-5',
                    lastSeenMs: now - 1800000
                },
                { 
                    id: 'oracle', 
                    name: 'Oracle', 
                    ...
                    status: 'thinking', 
                    currentTask: 'Long-term vision planning', 
                    emoji: '🔮', 
                    lastSeen: new Date(now - 900000).toISOString(), 
                    lastSeenRelative: '15m ago', 
                    tokensUsed: 11700, 
                    apiCalls: 37, 
                    model: 'claude-opus-4-6',
                    lastSeenMs: now - 900000
                },
                { 
                    id: 'pulse', 
                    name: 'Pulse', 
                    role: 'QA Lead', 
                    status: 'testing', 
                    currentTask: 'SpawnKit theme integration testing', 
                    emoji: '🧪', 
                    lastSeen: new Date(now - 240000).toISOString(), 
                    lastSeenRelative: '4m ago', 
                    tokensUsed: 7900, 
                    apiCalls: 28, 
                    model: 'claude-haiku-4-5',
                    lastSeenMs: now - 240000
                }
            ],
            subagents: [
                { 
                    id: 'sa-1', 
                    name: 'Theme Integration Specialist', 
                    agentOSName: 'Forge.CodeBuilder-01',
                    parentAgent: 'forge', 
                    parentDisplay: 'Forge',
                    role: 'CodeBuilder',
                    idStr: '01',
                    task: 'Wiring SpawnKit theme data bridges', 
                    status: 'running', 
                    progress: 0.73, 
                    startTime: new Date(now - 2100000).toISOString(),
                    displayNames: {
                        full: 'Forge.CodeBuilder-01',
                        abbreviated: 'F.CB-01'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('CodeBuilder'),
                    model: 'claude-sonnet-4'
                },
                { 
                    id: 'sa-2', 
                    ...
                    role: 'Researcher',
                    idStr: '01',
                    task: 'Competitive landscape analysis for Q1 launch', 
                    status: 'completed', 
                    progress: 1.0, 
                ...
                { 
                    ...
                    agentOSName: 'Echo.ContentCreator-01',
                    parentAgent: 'echo', 
                    parentDisplay: 'Echo',
                    role: 'ContentCreator',
                    idStr: '01',
                    task: 'Building comprehensive launch content calendar', 
                    status: 'running', 
                    progress: 0.62, 
                    startTime: new Date(now - 3600000).toISOString(),
                    displayNames: {
                        full: 'Echo.ContentCreator-01',
                        abbreviated: 'E.CC-01'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('ContentCreator'),
                    model: 'claude-haiku-4-5'
                },
                { 
                    id: 'sa-4', 
                    ...
                    role: 'OpsRunner',
                    idStr: '01',
                    task: 'Streamlining deployment workflows', 
                    status: 'running', 
                    progress: 0.45, 
                    startTime: new Date(now - 1800000).toISOString(),
                    displayNames: {
                        full: 'Atlas.OpsRunner-01',
                        abbreviated: 'A.OR-01'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('OpsRunner'),
                    model: 'claude-sonnet-4'
                },
                { 
                    id: 'sa-5', 
                    name: 'Security Compliance Auditor', 
                    agentOSName: 'Sentinel.Auditor-01',
                    parentAgent: 'sentinel', 
                    parentDisplay: 'Sentinel',
                    role: 'Auditor',
                    idStr: '01',
                    task: 'SOC 2 compliance preparation', 
                    status: 'running', 
                    progress: 0.81, 
                    startTime: new Date(now - 4200000).toISOString(),
                    displayNames: {
                        full: 'Sentinel.Auditor-01',
                        abbreviated: 'S.AU-01'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('Auditor'),
                    model: 'claude-haiku-4-5'
                },
                { 
                    id: 'sa-6', 
                    name: 'Feature Coordinator', 
                    agentOSName: 'Forge.TaskRunner-02',
                    parentAgent: 'forge', 
                    parentDisplay: 'Forge',
                    role: 'TaskRunner',
                    idStr: '02',
                    task: 'Cross-platform feature parity validation', 
                    status: 'running', 
                    progress: 0.38, 
                    startTime: new Date(now - 1200000).toISOString(),
                    displayNames: {
                        full: 'Forge.TaskRunner-02',
                        abbreviated: 'F.TR-02'
                    },
                ...
                { 
                    ...
                    agentOSName: 'Atlas.DataProcessor-01',
                    parentAgent: 'atlas', 
                    parentDisplay: 'Atlas',
                    role: 'DataProcessor',
                    idStr: '01',
                    task: 'Real-time analytics implementation', 
                    status: 'completed', 
                    progress: 1.0, 
                    startTime: new Date(now - 7200000).toISOString(),
                    endTime: new Date(now - 1800000).toISOString(),
                    displayNames: {
                        full: 'Atlas.DataProcessor-01',
                        abbreviated: 'A.DP-01'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('DataProcessor'),
                    model: 'claude-sonnet-4'
                },
                { 
                    id: 'sa-8', 
                    name: 'Brand Campaign Specialist', 
                    agentOSName: 'Echo.ContentCreator-02',
                    parentAgent: 'echo', 
                    parentDisplay: 'Echo',
                    role: 'ContentCreator',
                    idStr: '02',
                    task: 'Multi-channel brand campaign development', 
                    status: 'running', 
                    progress: 0.27, 
                    startTime: new Date(now - 900000).toISOString(),
                    displayNames: {
                        full: 'Echo.ContentCreator-02',
                        abbreviated: 'E.CC-02'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('ContentCreator'),
                    model: 'claude-haiku-4-5'
                ...
                { 
                    ...
                    agentOSName: 'Hunter.Researcher-02',
                    parentAgent: 'hunter', 
                    parentDisplay: 'Hunter',
                    role: 'Researcher',
                    idStr: '02',
                    task: 'User feedback synthesis and recommendations', 
                    status: 'running', 
                    progress: 0.55, 
                    startTime: new Date(now - 2700000).toISOString(),
                    displayNames: {
                        full: 'Hunter.Researcher-02',
                        abbreviated: 'H.RE-02'
                    },
                    roleInfo: AgentOSNaming.getRoleInfo('Researcher'),
                    model: 'claude-sonnet-4'
            ...
            missions: [
                { 
                    id: 'm-1', 
                    name: 'SpawnKit v2.0 Launch', 
                    title: 'SpawnKit v2.0 Launch',
                    status: 'in_progress', 
                    progress: 0.78, 
                    assignedAgents: ['kira', 'forge', 'atlas', 'echo'], 
                    startTime: new Date(now - 10800000).toISOString(), 
                    priority: 'critical',
                    description: 'Complete product launch with all themes and integrations'
                },
                { 
                    id: 'm-2', 
                    name: 'Market Expansion Strategy', 
                    title: 'Q1 2026 Market Expansion',
                    status: 'in_progress', 
                    progress: 0.65, 
                    assignedAgents: ['hunter', 'oracle', 'echo'], 
                    startTime: new Date(now - 7200000).toISOString(),
                    priority: 'high',
                    description: 'Strategic market analysis and expansion planning'
                },
                { 
                    id: 'm-3', 
                    ...
                    status: 'in_progress', 
                    progress: 0.43, 
                    assignedAgents: ['sentinel', 'cipher'], 
                    startTime: new Date(now - 9000000).toISOString(),
                    priority: 'high',
                    description: 'SOC 2 Type II compliance and security hardening'
                },
                { 
                    id: 'm-4', 
                ...
                { 
                    ...
                    status: 'in_progress', 
                    progress: 0.89, 
                    assignedAgents: ['vector', 'atlas'], 
                    startTime: new Date(now - 12600000).toISOString(),
                    priority: 'medium',
                    description: 'Real-time AI performance monitoring and insights'
                }
            ],
            crons: [
                { 
                    ...
                    nextRun: new Date(now + 43200000).toISOString(), // 12h from now
                    status: 'active', 
                    emoji: '🤝',
                    enabled: true,
                    owner: 'kira',
                    lastRun: new Date(now - 86400000).toISOString(), // 24h ago
                    description: 'Morning coordination meeting for all active agents'
                },
                { 
                    id: 'c-2', 
                    name: 'Security Sweep', 
                    schedule: 'Every 4 hours', 
                    nextRun: new Date(now + 14400000).toISOString(), // 4h from now
                    status: 'active', 
                    emoji: '🛡️',
                    enabled: true,
                    owner: 'sentinel',
                    lastRun: new Date(now - 14400000).toISOString(), // 4h ago
                ...
                { 
                    ...
                    schedule: 'Every hour', 
                    nextRun: new Date(now + 3600000).toISOString(), // 1h from now
                    status: 'active', 
                    emoji: '📊',
                    enabled: true,
                    owner: 'vector',
                    lastRun: new Date(now - 3600000).toISOString(), // 1h ago
                    description: 'System performance metrics collection and analysis'
                },
                { 
                    id: 'c-4', 
                    name: 'Git Repository Backup', 
                    schedule: 'Every 6 hours', 
                    nextRun: new Date(now + 21600000).toISOString(), // 6h from now
                    status: 'active', 
                    emoji: '💾',
                    enabled: true,
                    owner: 'cipher',
                    lastRun: new Date(now - 21600000).toISOString(), // 6h ago
                    description: 'Automated backup of all critical repositories'
                },
                { 
                    id: 'c-5', 
                    name: 'Weekly Strategy Review', 
                    schedule: 'Fridays 4:00 PM', 
                    nextRun: new Date(now + 432000000).toISOString(), // 5 days from now
                    status: 'active', 
                    emoji: '🎯',
                    enabled: true,
                    owner: 'oracle',
                    lastRun: new Date(now - 172800000).toISOString(), // 2 days ago
                    description: 'Strategic planning and goal alignment session'
                },
                { 
                    id: 'c-6', 
                    name: 'Content Pipeline Refresh', 
                    schedule: '6:00 AM daily', 
                    nextRun: new Date(now + 39600000).toISOString(), // 11h from now
                    status: 'active', 
                    emoji: '📝',
                    enabled: true,
                    owner: 'echo',
                    lastRun: new Date(now - 46800000).toISOString(), // 13h ago
                    description: 'Daily content planning and scheduling update'
                }
            ],
            metrics: {
                tokensToday: 147300,
            ...
            events: [
                {
                    ...
                    message: 'SpawnKit v2.0 Launch reached 78% completion',
                    severity: 'info',
                    source: 'forge'
                },
                {
                    ...
                    message: 'Market Research Analyst completed competitive analysis',
                    severity: 'success',
                    source: 'hunter'
                },
                {
                    ...
                    message: 'Oracle switched to strategic planning mode',
                    severity: 'info',
                    source: 'oracle'
                }
            ],
            memory: { 
                ...
                fileCount: 24, 
                totalSize: '156KB',
                longTerm: 'Strategic objectives for Q1 2026: Launch SpawnKit v2.0, achieve SOC 2 compliance, expand market reach by 40%. Key learnings: Multi-theme approach increases user engagement by 60%. Security-first architecture is non-negotiable for enterprise clients.',
                daily: [
                    { name: '2026-02-22.md', size: '12KB' },
                    { name: '2026-02-21.md', size: '18KB' },
                    { name: '2026-02-20.md', size: '15KB' }
                ],
                heartbeat: new Date(now - 60000).toISOString()
            }
        };
    }
    ...
    function mapRelayToSpawnKit(raw) {
        ...
        return {
            ...
            memory: {
                ...
                totalSize: (typeof memoryData.main === 'string' && memoryData.main) ? `${Math.round(memoryData.main.length / 1024)}KB` : '0KB',
                longTerm: (typeof memoryData.main === 'string' && memoryData.main) ? memoryData.main.substring(0, 1000) : null,
    ...
    function showDemoBadge() {
        ...
        badge.style.cssText = 'position:fixed;top:12px;right:12px;background:rgba(99,102,241,0.8);color:white;padding:4px 12px;border-radius:20px;font-size:10px;font-weight:600;font-family:Inter,system-ui,sans-serif;z-index:999999;backdrop-filter:blur(8px);pointer-events:auto;cursor:pointer;opacity:0.7;transition:opacity 0.2s ease;';
        
        // Click to hide badge, hover effects
