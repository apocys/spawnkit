  ...
  var features = [
    {
      ...
      action: function() { if (window.openDailyBriefPanel) window.openDailyBriefPanel(); }
    },
    {
      id: 'skill-forge',
      icon: '🔨',
    ...
    },
    {
      ...
      action: function() { if (window.openCreatorProfilePanel) window.openCreatorProfilePanel(); }
    },
    {
      id: 'add-agent',
      icon: '➕',
